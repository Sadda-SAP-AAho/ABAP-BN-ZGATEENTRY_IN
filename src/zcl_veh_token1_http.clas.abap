*class ZCL_VEH_TOKEN1_HTTP definition
*  public
*  create public .
*
*public section.
...
*
*
*CLASS ZCL_VEH_TOKEN1_HTTP IMPLEMENTATION.
*
*
...
*  |<form action="{ url }" method="POST">\n| &&
  |<form action="/sap/bc/http/sap/ZVEH_TOKEN1_HTTP?sap-client=080" method="POST">\n| &&
  |<H2>BN Print</H2> \n| &&
...
*     req_uri = request->get_request_uri( ).
    ...
    req_uri = '/sap/bc/http/sap/ZVEH_TOKEN1_HTTP?sap-client=080'.
...
*        TRANSLATE cc to UPPER CASE.
        ...
        IF lv_ge IS NOT INITIAL.
          ...
          TRY.
              DATA(pdf) = zcl_veh_token_xml1=>read_posts( lv_gateentry = gee  ) .
